...
export const GetRoturaController = async(centro,mov1,mov2,fechaini,fechafin,almacen) =>{
    let indicadorRotura = await GetRotura(centro, mov1, mov2, fechaini, fechafin,almacen);
