...
export const Product = {
  ...
  async Etiqueta(pallet) {
    let config = {
      method: "get",
      maxBodyLength: Infinity,
      url: `https://itaprd.ceramicaitalia.com:44301/sap/opu/odata/sap/ZPP_ETIQUETAS_SRV/ZPP_INFO_ETIQUETASet?$filter=PALLET eq '${pallet}'&$format=json`,
      headers: {
        Authorization:  process.env.GETNAME_AUTORIZATION,
        Cookie:process.env.GETNAME_COOKIE
      },
